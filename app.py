...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Ngọc Hà - Trường Tiểu học Vĩnh Hảo, xã Vĩnh Tuy, tỉnh tuyên Quan - ĐT: 0978 248 046</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Ngọc Hà - Trường Tiểu học Vĩnh Hảo, xã Vĩnh Tuy, tỉnh Tuyên Quang - ĐT: 0978 248046</div>", unsafe_allow_html=True)
